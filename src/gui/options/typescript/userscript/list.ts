...
export default function userscript_list_controller() {
    ...
    var self = {
        ...
        , refresh_userscript_list: async function (userscripts: any) {
        ...
        after_rendering: function () {
            ...
            event_controller().register.userscript.quota(function (quota:any) {
                ...
                var rounded_quota = (Math.round(quota * 100) / 100 + "").replace(".", ","),
                    currentMemoryUsage = browser.i18n.getMessage("actual_used_quota") + " : " + rounded_quota + "%";
