...
/* global userscript_handle, basic_helper, browser, GM_xhrHandler, userscript_storage */

export default function GM_Backend() {
    ...
    var self = {
        ...
        // neuen Tab öffnen
        , GM_openInTab: async function (data: any, userscript_id: number) {
            let url = data.url;
        ...
        , GM_registerMenuCommand: function (data: any) {
