    ...
    var last_css = [],
        ...
        self = {
            ...
            , after_rendering: function () {
                ...
                event_controller.register.userscript.update.available(function (userscript_infos) {
                    if (window.confirm(lang.getMessage("userscript_update_was_found_1") + userscript_infos.id + lang.getMessage("userscript_update_was_found_2"))) {
            ...
            , deleteAll: function () {
                ...
                if (window.confirm(lang.getMessage("really_reset_all_settings"))) {
                    if (window.confirm(lang.getMessage("really_really_reset_all_settings"))) {
