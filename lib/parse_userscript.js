	...
	find_settings: function (userscript) {
		...
		switch (true) {
			...
			case !basic_helper.isset(options.include):
				var error_text = "Du musst mindestens -eine- Include Anweisung setzen -> \n\n @include *webseite.de*";
			...
			case !basic_helper.isset(options.name):
				var error_text = "Du solltest schon einen Namen vergeben, er muss auch nicht global eindeutig sein -> \n\n @name mein_userscript";
				// keine gültige Konfiguration!
				return {error_message: error_text};
				break;
