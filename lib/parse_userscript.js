	...
	find_settings: function (userscript) {
		...
		switch (true) {
			...
			case !basic_helper.isset(options.include):
				var error_text = _("Du_musst_mindestens_eine_Include_Anweisung_setzen_include_webseite");
			...
			case !basic_helper.isset(options.name):
				var error_text = _("Du_solltest_schon_einen_Namen_vergeben_er_muss_auch_nicht_global_eindeutig_sein_name_mein_userscript");
				// keine gültige Konfiguration!
				return {error_message: error_text};
				break;
