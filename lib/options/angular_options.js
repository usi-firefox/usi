...
var cfx_jpm_helper = require("../configuration/cfx_jpm_helper").cfx_jpm_helper;
...
var angular_options = {
	...
	getAngularJsPath: function(){
		return cfx_jpm_helper.resource_path() + "libs/angularjs/";
	}
	/**
	...
	,getAngularJsMobilePath: function(){
		return cfx_jpm_helper.resource_path() + "libs/angularjs-mobile/";
	}
	/**
	...
	,getAngularJsMobileFontFiles: function(){
		var files = ["fontawesome-webfont.woff2"];
