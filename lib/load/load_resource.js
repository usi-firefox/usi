...
var basic_helper = require("data/helper/basic_helper").basic_helper,
    ...
    load_resource = (function () {
        ...
        return {
             ...
             * @returns {void}
             */
            load_image_or_text: function (url, callback, charset, error_callback) {
                    ...
                    xhr.onload = function () {
                        ...
                        try{
                            if (this.status === 200) {
                                ...
                                error_callback({url:url, code: this.status, XMLHttpRequest: this });
                                return false;
                            }

                        }catch(exception){
                            error_callback({url:url, code: 99999, XMLHttpRequest: this });
                            return false;
                        }
                    };
