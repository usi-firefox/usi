...
var parse_userscript = (function () {
    ...
    var self = {
        ...
        add_option_to_userscript_metablock: function (userscript, new_entries) {
            ...
            let userscript_rest = self.find_lines_with_settings(userscript, true);
            if (!userscript_rest) {
                return false;
            }

            let new_userscript_metablock = self.create_metablock_from_array(userscript_metablock, new_entries);
        ...
        create_metablock_from_array: function (userscript_metablock, new_entries) {
            ...
            return [self.metablock.start_s, userscript_metablock.join("\n"), self.metablock.end_s].join("\n");
        },
        ...
        find_lines_with_settings: function (userscript, getRestOfUserscript) {
            ...
            var userscript_lines = userscript.split("\n"),
                ...
                start_regex = self.metablock.start,
                end_regex = self.metablock.end,
        ...
        find_settings: function (userscript) {
            ...
            var userscript_settings = self.find_lines_with_settings(userscript);
        ...
        prepare_includes_and_excludes: function (rules) {
