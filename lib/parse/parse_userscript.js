...
parse_userscript = {
	...
	find_settings: function (userscript, alternative_name) {
		// Language
		...
		switch (true) {
			...
			case !basic_helper.isset(options.name):
				...
				// nimm den alternativ Namen, falls keiner im Userscript gefunden werden könnte
				if(!basic_helper.empty(alternative_name)){
					options.name = alternative_name;
