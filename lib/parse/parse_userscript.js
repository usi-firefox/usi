...
parse_userscript = {
	...
	find_settings: function (userscript) {
		...
		var possible_entries = [
			...
			{m: false,	val: "name",			types:["string"]},
			{m: false,	val: "namespace",		types:["string"]},
			{m: false,	val: "author",			types:["string"]},
			{m: false,	val: "homepageURL",		types:["url"]},
			{m: false,	val: "date",			types:["string"]},
			{m: false,	val: "license",			types:["string"]},
			{m: false,	val: "icon",			types:["string"]},
			{m: false,	val: "description",		types:["string"]},
			{m: true,	val: "exclude",			types:["url","regex"]},
			{m: true,	val: "match",			types:["url","regex"]},		// Match und Include werden gleich behandelt!
			{m: true,	val: "include",			types:["url","regex"]},		// Match und Include werden gleich behandelt!
			{m: false,	val: "clean-include",	types:["bool"]},			// verhindert das Extra Parsing der Includes durch USI
			{m: false,	val: "info",			types:["string"]},
			{m: true,	val: "resource",		types:["url"]},				// Damit du andere Dinge zusätzlich herunterladen kannst
			{m: false,	val: "run-at",			types:["string"]},			// document-end || document-start || document-ready
			{m: true,	val: "grant",			types:["string"]},
			{m: false,	val: "include-jquery",	types:["bool"]},			// true || false --- du brauchst zusätzlich jQuery? setze "true" || "false", keine sorge es wird vorher geprüft ob bereits jQuery auf der Seite existiert!
			{m: false,	val: "updateURL",		types:["url"]},				// Hierüber wird später geprüft ob eine neue Version vom Skript zur Verfügung steht
			{m: false,	val: "downloadURL",		types:["url"]},				// Hierüber wird später geprüft ob eine neue Version vom Skript zur Verfügung steht
			{m: false,	val: "version",			types:["string"]},
			{m: false,	val: "use-greasemonkey",types:["bool"]},			// true || false
			{m: true,	val: "options"	,		types:["string"]}			// Damit kannst du mehrere Werte bestimmen, die dein UserScript nutzen soll!
		];
