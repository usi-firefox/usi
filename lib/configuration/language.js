...
var key,
	...
	static___language_keys = ["loadOptions_title","loadOptions_label","enableExternalScriptLoadQuestion_title","enableExternalScriptLoadQuestion_description","required_script_one_include","required_script_name","exception_100","error_userscript_settings","usi_options","description","deactivated_userscript","add_new_userscript","load_userscript_by_url","after_load","userscript_after_load","load_userscript_by_url_label","load_userscript_by_textarea","load_example","clear_textarea","save_userscript","delete_all_userscripts","all_userscripts","create_new_userscript","revert_all","check_updates_for_all_userscripts","check_now","empty_userscript_url","same_userscript_was_found_ask_update_it_1","same_userscript_was_found_ask_update_it_2","yes","no","not_set","want_to_delete_this_userscript_1","want_to_delete_this_userscript_2","delete_x","change","show_hide","show","hide","activate_deactivate","activated","deactivated","actual_used_quota","userscript_was_successful_deleted","userscript_could_not_deleted","really_reset_all_settings","really_really_reset_all_settings","userscript_update_was_found_1","userscript_update_was_found_2","should_usi_import_this_userscript","language","menu","overview","overview_description","edit_userscript_with_id","no_userscript_there"];
/**
...
//console.log(searchKeysInProperties());
