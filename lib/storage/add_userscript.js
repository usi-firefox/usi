...
var add_userscript = (function () {
    ...
    var private_functions = {
         ...
         * @returns {boolean}
         */
        check_for_userscript_settings_and_save_it: function (userscript, worker, override_userscript_id, charset, moreinformations, update_callback) {
            ...
            if (us.error_code === 101 && !basic_helper.empty(alternative_name)) {
                ...
                if (override_userscript_id === null || !basic_helper.isset(override_userscript_id)) {
                    ...
                    if (old_userscript_was_found === 0) {
                        ...
                        return private_functions.update_userscript(userscript_handle, userscript, us, moreinformations, worker, update_callback);
        ...
        , update_userscript: function (userscript_handle, userscript, settings, moreinformations, worker, update_callback) {
            ...
            Promise.all(running_promises).then(function (answers) {
				...
				if(typeof update_callback === "function"){
					// Übergabe des Userscript Handles
					update_callback(userscript_handle);
				}
            });
