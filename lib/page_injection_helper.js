...
page_injection.PageMod({
	...
	,contentScriptFile: [
		cfx_jpm_helper.resource_path() + "libs/jquery-2.1.4.min.js" // always load jQuery
...
//                                contentScriptOptions: userscript_entry.options || {} 
		...
		if (script_settings["include-jquery"] == "true") {
			page_injection_object.contentScriptFile.push( cfx_jpm_helper.resource_path() + "libs/jquery-2.1.4.min.js");
		}
