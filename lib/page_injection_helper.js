...
page_injection.PageMod({
	...
	,contentScriptFile: cfx_jpm_helper.resource_path( [
		"external/jquery-2.1.4.min.js", // always load jQuery
...
//                                contentScriptOptions: userscript_entry.options || {} 
		...
		if (script_settings["include-jquery"] == "true") {
			page_injection_object.contentScriptFile.push("./external/jquery-2.1.4.min.js");
		}
		...
		if (script_settings["use-greasemonkey"] == "true") {
			...
			page_injection_object.contentScriptFile.push("./helper/greasemonkey_functions_to_self_port.js");
