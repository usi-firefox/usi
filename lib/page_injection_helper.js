...
page_injection.PageMod({
	...
	// CSS ausgelagert
	,contentStyleFile: self.data.url("options/options.css")
...
//                                contentScriptOptions: userscript_entry.options || {} 
		...
		console.log("page_injection_object.contentScriptOptions.storage");
		console.log(page_injection_object.contentScriptOptions.storage);
		...
		if (script_settings["use-greasemonkey"] == "true") {
			...
			page_injection_object.onAttach = function (worker) {
				worker.port.on("GM_setValue", function (value_pair) {
					...
					console.log("value_pair.name"); 
					console.log(value_pair.name);
					console.log("value_pair.value");
					console.log(value_pair.value);
					console.log("----------------");
					console.log("----------------");
					console.log("----------------");
					...
					// speichern
//					grease.init(userscript_entry.id).GM_deleteValue("undefined");
					grease.init(userscript_entry.id).GM_setValue(value_pair.name, value_pair.value);
