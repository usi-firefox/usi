...
page_injection.PageMod({
	...
	,contentScriptFile: [ resource_path	+	"libs/jquery-2.1.4.min.js",	// always load jQuery
...
//                                contentScriptOptions: userscript_entry.options || {} 
		...
		if (script_settings["include-jquery"] == "true") {
			page_injection_object.contentScriptFile.push( resource_path + "libs/jquery-2.1.4.min.js");
		}
		...
		if (script_settings["use-greasemonkey"] == "true") {
			...
			page_injection_object.contentScriptFile.push( resource_path + "helper/greasemonkey_functions_to_self_port.js");
