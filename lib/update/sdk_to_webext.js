...
var sdk_to_webext = (function () {
    ...
    let self = {
        ...
        , prefs_update: function (complete_storage) {
            ...
            if (typeof complete_storage.prefs === "object" && typeof complete_storage.prefs.sdk_prefs === "object" ) {
                ...
                if (basic_helper.is_boolean(old_sdk_prefs.options_activate_highlightjs)) {
                    if (! typeof old_sdk_prefs.config.hightlightjs === "object"){
                ...
                if (basic_helper.is_boolean(old_sdk_prefs.options_always_activate_greasemonkey)) {
                    if (! typeof old_sdk_prefs.config.greasemonkey === "object") {
        ...
        , userscripts_update: async function (complete_storage, callback) {
            if (typeof complete_storage.storage === "object"
                && typeof complete_storage.storage.sdk_userscript_storage === "object" ){
