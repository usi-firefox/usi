...
page_injection.PageMod({
	...
	// CSS ausgelagert
	,contentStyleFile: [resource_path + "options/css/extra.css", resource_path + "libs/highlight/styles/default.css"].concat(angular_options.getAngularJsMobileCSSFiles())
