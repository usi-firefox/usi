...
//					xhr.mozSystem = true;
			...
			GM_xhrHandler.createSimpleRequestEvent(xhr, "load", counter, worker);
			GM_xhrHandler.createSimpleRequestEvent(xhr, "loadstart", counter, worker);
			GM_xhrHandler.createSimpleRequestEvent(xhr, "loadend", counter, worker);
			GM_xhrHandler.createSimpleRequestEvent(xhr, "abort", counter, worker);
			GM_xhrHandler.createSimpleRequestEvent(xhr, "progress", counter, worker);
			GM_xhrHandler.createSimpleRequestEvent(xhr, "error", counter, worker);
			GM_xhrHandler.createSimpleRequestEvent(xhr, "readystatechange", counter, worker);
			GM_xhrHandler.createSimpleRequestEvent(xhr, "timeout", counter, worker);
