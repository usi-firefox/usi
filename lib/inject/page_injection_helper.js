...
var page_injection_helper = (function () {
    ...
    var self = {
        ...
        , create_spa_userscript_exec_object : async function (userscript_handle){
            ...
            original_userscript = self.createUserscriptContent(userscript_handle);
            ...
            gm.prefilled_data.scriptSource = original_userscript;
            ...
            let contentScript = original_userscript;
            ...
            if (typeof script_settings["include-jquery"] !== "undefined") {
                if (script_settings["include-jquery"] === "true" || script_settings["include-jquery"] === true) {
                    contentScript += await load_resource.load_internal_file("/gui/libs/jquery/jquery-3.3.1.min.js");
                }
            }
        ...
        /**
         * Erzeugt/Modifiziert den Userscript Inhalt, mit den Require Skripten
         * @param {object} userscript_handle
         * @returns {string}
         */
