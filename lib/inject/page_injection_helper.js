...
//								,"64": "./icon/icon-64.png"
	 ...
	 ************************************************************************/
	  ...
	  * @returns {void}
	  */
	 , load_image_and_convert_to_datauri : function(url, callback, charset){
					...
					for(var j in us.resource){
						...
						if(/^http/.test(resource_url)){
							...
							(function(c){
								...
								this_module.load_image_and_convert_to_datauri(c.resource_url, function (data, response_contenttype) {
